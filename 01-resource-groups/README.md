...
3. Consultar información sobre el Resource Group
...
<br>
Para crearlo necesitamos especificar la suscripción a la que va asociada (en mi caso la gratuita), el nombre del grupo (RG_Lab01_ResourceGroups) y la region del grupo (Spain Central).<br>
<br>
